...
cmd_request_absolution = cmd_prefix + 'requestabsolution'
...
item_id_slimecorpcpu = "slimecorpcpu"
item_id_deathssoul = "deathssoul"
item_id_magnuscarlslimesoul = "magnuscarlslimesoul"
...
weapon_id_autohotkey="autohotkey"
...
help_responses = {
    ...
    "capturing": "Capping is a battle for influence over the 33 districts of NLACakaNM and some of its Islands, and one of your main goals as a gangster. Capped territories award your kingpin slime, give your teammates benefits, doubling their speed and halving the price of food and doing the same to your enemies but like the opposite. You will automatically capture for your gang if you are enlisted and have more than 200,000 slime on you. Capturing creates influence for you, or decrease it for the enemy if they have influence there. Think of yourself mindlessly vandalizing the walls of the city wherever you go so long as you have the slime to do the deed. As you go, you can check your **!progress** to see how much influence you still need. It can be more or less depending on the territory class, running from rank C to S. \n\nA few more things to note:\n>You can't capture districts locked by surrounding captured districts, and that includes trying to top up progress of districts your own gang has locked in.\n>Don't attack enemy territory when it is surrounded by enemy territory/outskirts. Small little bitches like yourself are prone to fucking up severely under that much pressure.\n>The nightlife starts in the late night. Fewer cops are around to erase your handiwork, so if you cap then you will gain a 33% capping bonus.\n>",
    ...
    "NPCs": "On your travels around NLACakaNM you will encounter **NPCs**, unlike regular enemies and gangsters **NPCs** *might* not attack you! \n\n You can interact with **NPCs** the same way you can with most players and monsters, they appear when you !survey and can be examined with !data. Unlike monsters they can be !talk'ed to, be challenged to a !slimeoidbattle (a good early source of slimecoin (if they have a slimeoid)) and sometimes !trade-d with.\n Also unlike most monsters **NPCs** don't always carry slime with them, making it advisable to do a !data before you !kill, should you choose to hunt them for their valuables anyway. That being said **NPCs** aren't always friendly, they can attack you, have negative effects when in a district and some can be as strong as any monster.",
...
mutation_descriptions = {
    ...
    mutation_id_trashmouth: "Reach maximum power scavenges 3 times as fast. Example: The soft cooldown of 15 seconds on scavenging is now reduced to 5 seconds. You can also eat furniture and cosmetics using !devour <item>.",
